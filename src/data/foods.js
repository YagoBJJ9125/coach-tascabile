...
export const SEED_FOODS = [
  ...
  // --- colazione tipica ---
  { id: "f_fette_biscottate", name: "Fette biscottate", emoji: "🍞", cat: "cereali",
    per100: { kcal: 408, p: 11, c: 73, f: 6 },
    portions: [{ label: "fetta (8g)", grams: 8 }, { label: "g", grams: 1 }],
    micros: { fibra: 4, sodio: 470 } },
  { id: "f_biscotti_secchi", name: "Biscotti secchi", emoji: "🍪", cat: "dolci",
    per100: { kcal: 416, p: 7, c: 75, f: 10 },
    portions: [{ label: "biscotto (8g)", grams: 8 }, { label: "porzione (30g)", grams: 30 }, { label: "g", grams: 1 }],
    micros: { grassiSaturi: 4, zuccheri: 22, fibra: 2.5 } },
  { id: "f_marmellata", name: "Marmellata / Confettura", emoji: "🍓", cat: "dolci",
    per100: { kcal: 250, p: 0.4, c: 60, f: 0.1 },
    portions: [{ label: "cucchiaio (20g)", grams: 20 }, { label: "g", grams: 1 }],
    micros: { zuccheri: 55 } },
  { id: "f_miele", name: "Miele", emoji: "🍯", cat: "dolci",
    per100: { kcal: 304, p: 0.3, c: 82, f: 0 },
    portions: [{ label: "cucchiaino (10g)", grams: 10 }, { label: "g", grams: 1 }],
    micros: { zuccheri: 82 } },
  { id: "f_cornflakes", name: "Cornflakes", emoji: "🥣", cat: "cereali",
    per100: { kcal: 378, p: 7, c: 84, f: 0.9 },
    portions: [{ label: "porzione (30g)", grams: 30 }, { label: "g", grams: 1 }],
    micros: { fibra: 3, zuccheri: 8, ferro: 8, sodio: 530 } },
  { id: "f_burro_arachidi", name: "Burro d'arachidi", emoji: "🥜", cat: "frutta secca",
    per100: { kcal: 588, p: 25, c: 20, f: 50 },
    portions: [{ label: "cucchiaio (15g)", grams: 15 }, { label: "g", grams: 1 }],
    micros: { grassiSaturi: 10, fibra: 6, magnesio: 154, potassio: 649 } },
  { id: "f_crema_cacao", name: "Crema cacao e nocciole", emoji: "🍫", cat: "dolci",
    per100: { kcal: 539, p: 6, c: 57, f: 31 },
    portions: [{ label: "cucchiaio (15g)", grams: 15 }, { label: "g", grams: 1 }],
    micros: { grassiSaturi: 11, zuccheri: 57 } },
  { id: "f_burro", name: "Burro", emoji: "🧈", cat: "condimenti",
    per100: { kcal: 717, p: 0.9, c: 0.7, f: 81 },
    portions: [{ label: "noce (10g)", grams: 10 }, { label: "g", grams: 1 }],
    micros: { grassiSaturi: 51, vitA: 684 } },
  { id: "f_yogurt_frutta", name: "Yogurt alla frutta", emoji: "🍑", cat: "latticini",
    per100: { kcal: 95, p: 3.8, c: 14, f: 2.5 },
    portions: [{ label: "vasetto (125g)", grams: 125 }, { label: "g", grams: 1 }],
    micros: { grassiSaturi: 1.6, zuccheri: 13, calcio: 120 } },
  { id: "f_succo_arancia", name: "Succo d'arancia", emoji: "🧃", cat: "bevande",
    per100: { kcal: 45, p: 0.7, c: 10, f: 0.2 },
    portions: [{ label: "bicchiere (200ml)", grams: 200 }, { label: "ml", grams: 1 }],
    micros: { vitC: 40, zuccheri: 9, potassio: 200 } },
];
